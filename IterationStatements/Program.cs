namespace IterationStatements
{
    public class Program
    {
        ...
        public static void CanVote()
        {
            ...
            var canParse = int.TryParse(Console.ReadLine(), out int usersAge);

            while (canParse == false)
            {
                Console.WriteLine("Please enter a valid age:");
                canParse = int.TryParse(Console.ReadLine(), out usersAge);
            }

            if(usersAge >= 18)
            {
                Console.WriteLine($"Congrats, {usersAge} is old enough to vote!");
            }
            else
            {
                Console.WriteLine($"Sorry, {usersAge} is not old enough to vote!");
            }
        ...
        static void Main(string[] args)
        {
            ...
            // 6. CanVote()
            // 7. TenRange() "Heating Up"
            // 8. MultiplyThroughTwelve(int number) "Heating Up"
